...
train_logger = get_logger("AI_Training", "training.log")
pred_logger = get_logger("AI_Prediction", "prediction.log")
eval_logger = get_logger("AI_Evaluation", "evaluation.log")
